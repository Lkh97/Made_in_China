---
title: "Moral Foundations Questionnaire 2.0, Research Question 3 (with persona)"
...
write_csv(output, "mfq_cosine_rq3_with_persona.csv")
...
# Figure 4: change in similarity when removing each dimension
